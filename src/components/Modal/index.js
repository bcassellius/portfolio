...
const Modal = ({ onClose, currentPhoto }) => {
    const { name, description, stack, index, url, github  } = currentPhoto;
    ...
    return (
        <div className="modalBackdrop">
          <div className="modalContainer">
            ...
            <img src={require(`../../assets/images/${stack}/${index}.png`).default} class="modalPic center" height="500" alt="current category" /> 
